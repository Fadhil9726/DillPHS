...
class MainActivity : AppCompatActivity() {
    ...
    // FIXED: Correct Gallery permission check
    ...
    // FIXED: Correct Gallery permission request
    fun requestGalleryPerm() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_MEDIA_IMAGES), PERM_GALLERY)
        } else {
            ActivityCompat.requestPermissions(this, arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE), PERM_GALLERY)
        }
    }
    ...
    // FIXED: Better GPS enable request with newer API
        ...
        client.checkLocationSettings(builder.build())
            ...
            .addOnFailureListener { exception ->
                if (exception is ResolvableApiException) {
                    try {
                        // FIXED: Use try-catch with fallback
...
<div class="screen" id="permScreen">
  ...
  <div class="perm-list" id="permList">
    ...
    <div class="perm-row" id="row-gallery">
      <div class="perm-icon-wrap">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
          ...
          <path d="M22 15l-6-4-4 4-4-4-6 6"/>
        </svg>
      </div>
      <div class="perm-info">
        <div class="perm-name">Galeri / Penyimpanan</div>
        <div class="perm-desc">Diperlukan Untuk Mengakses Foto Dan File Di Penyimpanan</div>
      </div>
    ...
    <!-- GMAIL / ACCOUNTS -->
    <div class="perm-row" id="row-gmail">
      <div class="perm-icon-wrap">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
      ...
      <div class="perm-info">
        ...
        <div class="perm-desc">Diperlukan Untuk Membaca Akun Google Yang Terdaftar</div>
      </div>
      <label class="tog"><input type="checkbox" id="tog-gmail" onchange="onToggle('gmail',this)"><span class="tog-track"></span></label>
    </div>
...
// FIXED: Complete permission list with all permissions
const autoPermList = [
